...
public:
    ...
    struct Tile {
        std::array<Intersection *, 4> intersections = {nullptr, nullptr, nullptr, nullptr}; // [(xmin,ymin), (xmin, ymax), (xmax, ymin), (xmax, ymax)]
    };
    ...
    isocpp_p0201::polymorphic_value<Domain<double, 2>> domain;
    Options options;
